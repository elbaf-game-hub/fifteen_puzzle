...
- [ ] `pubspec.yaml` has:
  ...
  - `homepage: https://github.com/elbaf-game-hub/fifteen_puzzle`
  - `repository: https://github.com/elbaf-game-hub/fifteen_puzzle`
  - `issue_tracker: https://github.com/elbaf-game-hub/fifteen_puzzle/issues`
